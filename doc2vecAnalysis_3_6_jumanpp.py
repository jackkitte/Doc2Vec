...
def doc2vec(docs):
    ...
    model.save("Data/model/Jumanpp/doc2vec_dmpv.model")
...
def kmeans(dense, docs_title, id2doc, start, end):
    ...
    for cluster in range(start, end):
        ...
        with open("Data/clustering/Jumanpp/dmpv/clustering_{0}_result.txt".format(cluster), "w") as f:
        ...
        with open("Data/clustering/Jumanpp/dmpv/clustering_result_{0}_list.txt".format(cluster), "w") as f:
...
if __name__ == "__main__":
    ...
    docs, docs_title, dictionary = create_gensim_dictionary("/home/tamashiro/AI/OPC/Data/対応方法")
    model = doc2vec(docs)
